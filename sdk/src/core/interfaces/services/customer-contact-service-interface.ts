...
/**
 * Defines methods defination for customer contact to interact with customer contact repository.
 *
 * @interface CustomerContactServiceInterface
 */
export interface CustomerContactServiceInterface {
    /**
