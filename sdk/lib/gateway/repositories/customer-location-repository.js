...
var CustomerLocationRepository = (function () {
    ...
    CustomerLocationRepository.prototype.getByCustomerId = function (id, customerLocationOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        this.customerLocationOptionsModel.customer_location_id = customerLocationOptions === null || customerLocationOptions === void 0 ? void 0 : customerLocationOptions.customerLocationId;
                        apiRequest = (0, helpers_1.createApiRequest)(api_paths_1.apiPaths.getCustomerLocationByIdApi(id), 'GET', '', this.customerLocationOptionsModel);
                        return [4, this.boomtownClient.request(apiRequest)];
                    case 1:
                        result = _a.sent();
                        return [2, customer_location_map_1.CustomerLocationMap.responseCustomerLocationMapper(result.data)];
                    case 2:
                        error_1 = _a.sent();
    ...
    CustomerLocationRepository.prototype.post = function (customerLocationCreateRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var payload, apiRequest, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        payload = JSON.stringify(customer_location_map_1.CustomerLocationMap.toBTCreateRequestModel(customerLocationCreateRequest));
                        apiRequest = (0, helpers_1.createApiRequest)(api_paths_1.apiPaths.createUpdateCustomerLocationApi, 'POST', payload);
                        return [4, this.boomtownClient.request(apiRequest)];
                    case 1:
                        result = _a.sent();
                        return [2, customer_location_map_1.CustomerLocationMap.responseCustomerLocationMapper(result.data)];
    ...
    CustomerLocationRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        apiRequest = (0, helpers_1.createApiRequest)(api_paths_1.apiPaths.deleteCustomerLocationApi(id), 'POST');
                        return [4, this.boomtownClient.request(apiRequest)];
                    case 1:
                        result = _a.sent();
    ...
    CustomerLocationRepository.prototype.getByExternalId = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        apiRequest = (0, helpers_1.createApiRequest)(api_paths_1.apiPaths.getCustomerLocationByExternalIdApi, 'GET', '', this.customerLocationOptionsModel);
                        return [4, this.boomtownClient.request(apiRequest)];
                    case 1:
                        result = _a.sent();
                        return [2, customer_location_map_1.CustomerLocationMap.responseCustomerLocationMapper(result.data)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        apiRequest = (0, helpers_1.createApiRequest)(api_paths_1.apiPaths.getCustomerLocationMetaStatus, 'GET');
                        return [4, this.boomtownClient.request(apiRequest)];
                    case 1:
                        result = _a.sent();
...
//# sourceMappingURL=customer-location-repository.js.map