...
var BoomtownClient = (function () {
    ...
    BoomtownClient.prototype.request = function (apiRequestModel) {
        return __awaiter(this, void 0, void 0, function () {
            var timestamp, sign;
            return __generator(this, function (_a) {
                timestamp = new Date();
                sign = signature_1.signature.create(apiRequestModel.url, timestamp, apiRequestModel.queryParameter);
                return [2, this.axiosHandler.request(apiRequestModel, sign, timestamp)];
            });
        });
    };
...
exports.BoomtownClient = BoomtownClient;
//# sourceMappingURL=boomtown-client.js.map